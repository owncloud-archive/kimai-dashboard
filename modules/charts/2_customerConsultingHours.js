...
const CustomerConsultingHours = ({ fromDate, toDate }) => {
    const { data, error } = useSWR(['/api/customerConsultingHours', fromDate, toDate], fetcher);
...
export default CustomerConsultingHours;